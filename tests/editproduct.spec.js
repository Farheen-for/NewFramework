...
test("Create Product", async ({page, managerpage }) => {
    ...
    const productName1 = ExcelUtils.getCellData("Sheet1", "B2");
    ...
    const category1 = ExcelUtils.getCellData("Sheet1", "J2");
...
//  await managerpage.productpage.verifyProductPresent(productName);
 await managerpage.editproductpage.editProduct(category1);
});